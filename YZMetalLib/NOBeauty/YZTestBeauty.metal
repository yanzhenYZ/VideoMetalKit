...
vertex YZBrightnessVertexIO YZTestBrightnessInputVertex(const device packed_float2 *position [[buffer(0)]], const device packed_float2 *texturecoord [[buffer(1)]], uint vertexID [[vertex_id]])
{
...
fragment half4 YZTestBrightnessFragment(YZBrightnessVertexIO fragmentInput [[stage_in]],
                                  texture2d<half> inputTexture [[texture(0)]],
                                  constant YZBrightnessUniform& uniform [[ buffer(0) ]])
{
